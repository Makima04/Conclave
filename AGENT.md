...
5. `docs/html/dynamic-master-architecture.html`
6. `docs/html/agent-boundaries.html`
...
- 改动态总控架构、4 层流水线、Agent 生命周期、Turn State、压缩 Agent：读 `docs/html/dynamic-master-architecture.html`
