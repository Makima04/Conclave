...
/**
 * Process SillyTavern-compatible macros in a string.
 *
 * Handles nested macros by running up to MAX_MACRO_DEPTH passes.
 * Variable mutations (setvar, incvar, etc.) are applied to context.variables.
 *
